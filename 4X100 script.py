...
class TrackandField():
    ...
    def selectDropdown(self):
        ...
        eventselect.select_by_visible_text("4 x 100 Relay")
        time.sleep(3)
    ...
    def dataframecreation(self):
        ...
        data_tuples = list(zip(team_list[0:],numbers_list[0:]))  # list of each players name and salary paired together
        ...
        self.df.to_csv(r'C:\Users\marit\Downloads\Top_100_NCAA_4X100m', index=False, header=True)
